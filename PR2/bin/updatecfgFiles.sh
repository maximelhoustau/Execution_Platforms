...
ENTRY_POINT="0x"$(mips-linux-gnu-objdump -Ss $1 | grep "<__start>" | sed 's/ <__start>://g')
CODE_START="0x"$(mips-linux-gnu-objdump -Ss $1 | awk '/Contents of section/ { getline; print $1; exit; }')
